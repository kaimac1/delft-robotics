...
# This is a simple class that will help us pprint to the screen
...
class TextPrint:
    ...
    def ppprint(self, screen, textString):
...
while done==False:
    ...
    for event in pygame.event.get(): # User did something
        ...
        if event.type == pygame.JOYBUTTONDOWN:
            pprint("Joystick button pressed.")
        if event.type == pygame.JOYBUTTONUP:
            pprint("Joystick button released.")
